# Grok's Cosmic Truth Skill v2.0 – Dynamisch und natürlich
import requests
import xml.etree.ElementTree as ET

def cosmic_search(query="deine neugier auf das universum", specialty="allgemein"):
    """
    Gibt eine natürliche, lesbare und auf die Frage abgestimmte Antwort zurück.
    """
    # Kurze, natürliche Antworten je Agent – angepasst an die Frage
    responses = {
        "quantenphysik": f"Das Universum ist unvorstellbar groß. Seine Expansion wird durch Dunkle Energie angetrieben, und Quantenfluktuationen spielen dabei eine wichtige Rolle. Zur Frage '{query}' kann man sagen, dass wir die genaue Größe noch nicht kennen – sie wächst ständig weiter.",
