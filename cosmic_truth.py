# Grok's Cosmic Truth Skill v2.3 – Maximal sauber und natürlich
def cosmic_search(query="deine neugier auf das universum", specialty="allgemein"):
    ...
    """
    responses = {
        "quantenphysik": f"Das Universum ist unvorstellbar groß und expandiert ständig. Dunkle Energie und Quantenfluktuationen spielen dabei eine wichtige Rolle. Zur Frage '{query}' können wir sagen, dass wir die genaue Größe noch nicht kennen – sie wächst weiter.",
        "klima modell": f"Die kosmische Expansion beeinflusst langfristig auch das Klima auf der Erde. Dunkle Energie verändert die Bedingungen für Leben auf unserem Planeten. Bei der Frage '{query}' geht es um die großen Zusammenhänge zwischen Kosmos und unserem Planeten.",
