...
def cosmic_search(query="deine neugier auf das universum", specialty="allgemein"):
    """
    Gibt eine kurze, natürliche und direkt auf die Frage abgestimmte Antwort.
    """
    # Direkte, natürliche Antworten je Agent
    responses = {
        ...
        "universelle wahrheitssuche": f"Die Größe des Universums ist eine der tiefsten Fragen der Menschheit. Die Wahrheit liegt in der Spannung zwischen dem, was wir messen können, und dem, was wir noch nicht verstehen. Deine Frage '{query}' berührt genau diesen Punkt.",
